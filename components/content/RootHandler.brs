        ...
        if json <> invalid ' and json.rows <> invalid and json.rows.Count() > 0
            ...
            for each item in json
                ...
                ' if item <> "providerName" and item <> "lastUpdated" and item <> "language"
                    ...
                    else if rowAA.title = "family"
                        rowAA.title = "Familia"
                    else if rowAA.title = "entertainment"
                        rowAA.title = "Entretenimiento"
                    else if rowAA.title = "general"
                        rowAA.title = "General"
                    else if rowAA.title = "extra"
                        rowAA.title = "Extra"
                    else if rowAA.title = "animation"
                        rowAA.title = "Animación"
                    else if rowAA.title = "culture"
                        rowAA.title = "Cultura"
